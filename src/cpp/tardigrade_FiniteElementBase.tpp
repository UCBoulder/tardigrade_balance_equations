...
namespace tardigradeBalanceEquations {
    ...
    namespace finiteElement {
        ...
        FiniteElementBase<element_configuration, node_in, local_point_in
         ...
         */
        template <class element_configuration, class node_in, class local_point_in>
        void FiniteElementBase<element_configuration, node_in,local_point_in>::GetShapeFunctions(const local_point_in &xi_begin, const local_point_in &xi_end,
         ...
         */
        template <class element_configuration, class node_in,  class local_point_in>
        void FiniteElementBase<element_configuration, node_in, local_point_in>::GetLocalShapeFunctionGradients(const local_point_in &xi_begin, const local_point_in &xi_end,
         ...
         */
        template <class element_configuration, class node_in,  class local_point_in>
        void FiniteElementBase<element_configuration, node_in, local_point_in>::GetGlobalShapeFunctionGradients(const local_point_in &xi_begin, const local_point_in &xi_end,
         ...
         */
        template <class element_configuration, class node_in,  class local_point_in>
        void FiniteElementBase<element_configuration, node_in, local_point_in>::GetVolumeIntegralJacobianOfTransformation(
         ...
         */
        template <class element_configuration, class node_in,  class local_point_in>
        void FiniteElementBase<element_configuration, node_in, local_point_in>::GetSurfaceIntegralJacobianOfTransformation(
         ...
         */
        template <class element_configuration, class node_in,  class local_point_in>
        void FiniteElementBase<element_configuration, node_in, local_point_in>::GetVolumeIntegrationPointData(const unsigned int i, typename element_configuration::local_point_out xi_begin, typename element_configuration::local_point_out xi_end, typename element_configuration::volume_integration_point_weight_value_type &weight){
         ...
         */
        template <class element_configuration, class node_in,  class local_point_in>
        void FiniteElementBase<element_configuration, node_in, local_point_in>::GetSurfaceIntegrationPointData(const unsigned int s, const unsigned int i, typename element_configuration::local_point_out xi_begin,
        ...
        void FiniteElementBase<element_configuration, node_in, local_point_in>::InterpolateQuantity(const local_point_in &xi_begin, const local_point_in &xi_end,
        ...
        void FiniteElementBase<element_configuration, node_in, local_point_in>::GetLocalQuantityGradient(const local_point_in &xi_begin, const local_point_in &xi_end,
                                      const quantity_in &quantity_begin, const quantity_in &quantity_end,
        ...
        template <class element_configuration, class node_in,  class local_point_in>
        template <class quantity_in, class quantity_gradient_out>
        void FiniteElementBase<element_configuration, node_in, local_point_in>::GetGlobalQuantityGradient(const local_point_in &xi_begin, const local_point_in &xi_end,
                                       const quantity_in &quantity_begin, const quantity_in &quantity_end,
                                       quantity_gradient_out value_begin, quantity_gradient_out value_end,
