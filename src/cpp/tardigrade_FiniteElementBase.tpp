...
namespace tardigradeBalanceEquations {
    ...
    namespace finiteElement {
        ...
        template <class element_configuration, class node_in, class local_point_in,
                  class shape_functions_out, class grad_shape_functions_out>
        void FiniteElementBase<element_configuration, node_in,local_point_in,shape_functions_out,grad_shape_functions_out>::GetShapeFunctions(const local_point_in &xi_begin, const local_point_in &xi_end,
        ...
        template <class element_configuration, class node_in,  class local_point_in,
                  class shape_functions_out, class grad_shape_functions_out>
        void FiniteElementBase<element_configuration, node_in, local_point_in,shape_functions_out,grad_shape_functions_out>::GetLocalShapeFunctionGradients(const local_point_in &xi_begin, const local_point_in &xi_end,
        ...
        template <class element_configuration, class node_in,  class local_point_in,
                  class shape_functions_out, class grad_shape_functions_out>
        void FiniteElementBase<element_configuration, node_in, local_point_in,shape_functions_out,grad_shape_functions_out>::GetGlobalShapeFunctionGradients(const local_point_in &xi_begin, const local_point_in &xi_end,
        ...
        template <class element_configuration, class node_in,  class local_point_in,
                  class shape_functions_out, class grad_shape_functions_out>
        void FiniteElementBase<element_configuration, node_in, local_point_in,shape_functions_out,grad_shape_functions_out>::GetVolumeIntegralJacobianOfTransformation(
        ...
        template <class element_configuration, class node_in,  class local_point_in,
                  class shape_functions_out, class grad_shape_functions_out>
        void FiniteElementBase<element_configuration, node_in, local_point_in,shape_functions_out,grad_shape_functions_out>::GetSurfaceIntegralJacobianOfTransformation(
        ...
        template <class element_configuration, class node_in,  class local_point_in,
                  class shape_functions_out, class grad_shape_functions_out>
        void FiniteElementBase<element_configuration, node_in, local_point_in,shape_functions_out,grad_shape_functions_out>::GetVolumeIntegrationPointData(const unsigned int i, typename element_configuration::local_point_out xi_begin, typename element_configuration::local_point_out xi_end, typename element_configuration::volume_integration_point_weight_value_type &weight){
        ...
        template <class element_configuration, class node_in,  class local_point_in,
                  class shape_functions_out, class grad_shape_functions_out>
        void FiniteElementBase<element_configuration, node_in, local_point_in, shape_functions_out, grad_shape_functions_out>::GetSurfaceIntegrationPointData(const unsigned int s, const unsigned int i, typename element_configuration::local_point_out xi_begin,
        ...
        void FiniteElementBase<element_configuration, node_in, local_point_in,shape_functions_out,grad_shape_functions_out>::InterpolateQuantity(const local_point_in &xi_begin, const local_point_in &xi_end,
        ...
        void FiniteElementBase<element_configuration, node_in, local_point_in,shape_functions_out,grad_shape_functions_out>::GetLocalQuantityGradient(const local_point_in &xi_begin, const local_point_in &xi_end,
                                      const quantity_in &quantity_begin, const quantity_in &quantity_end,
        ...
        template <class element_configuration, class node_in,  class local_point_in,
                  class shape_functions_out, class grad_shape_functions_out>
        template <class quantity_in, class quantity_gradient_out>
        void FiniteElementBase<element_configuration, node_in, local_point_in,shape_functions_out,grad_shape_functions_out>::GetGlobalQuantityGradient(const local_point_in &xi_begin, const local_point_in &xi_end,
                                       const quantity_in &quantity_begin, const quantity_in &quantity_end,
                                       quantity_gradient_out value_begin, quantity_gradient_out value_end,
