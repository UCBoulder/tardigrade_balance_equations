    ...
    namespace balanceOfEnergy {
        ...
        void computeBalanceOfEnergy(
            ...
            computeBalanceOfEnergy<configuration>(
                ...
                material_response_begin + interphasic_force_index + configuration::material::dimension,
                        ...
                        for (unsigned int a = 0; a < configuration::material::dimension; ++a) {
                            *(dRdUMesh_begin + a) -=
                                ...
                                (*(material_response_jacobian_begin +
                                   (nphases * num_phase_dof + configuration::material::num_additional_dof) * (1 + configuration::material::dimension) *
                                       (cauchy_stress_index + j) +
                                   (nphases * num_phase_dof + configuration::material::num_additional_dof) + configuration::material::dimension * I + k)) *
        ...
        void computeBalanceOfEnergy(
            ...
            for (auto v = std::pair<unsigned int, density_iter>(0, density_begin); v.second != density_end;
                 ++v.first, ++v.second) {
                computeBalanceOfEnergy<configuration, cauchy_stress_index,
        ...
        void computeBalanceOfEnergy(
            ...
            TARDIGRADE_ERROR_TOOLS_CHECK(
                (nphases * num_phase_dof + configuration::material::num_additional_dof) * configuration::material::dimension ==
            ...
            for (auto v = std::pair<unsigned int, density_iter>(0, density_begin); v.second != density_end;
                ...
                computeBalanceOfEnergy<
                    ...
                    *(result_begin + v.first), dRdRho_begin + nphases * v.first, dRdRho_begin + nphases * (v.first + 1),
                    ...
                    dRdVolumeFraction_begin + nphases * (v.first + 1), dRdZ_begin + configuration::material::num_additional_dof * v.first,
