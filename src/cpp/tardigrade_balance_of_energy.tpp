...
namespace tardigradeBalanceEquations {
    ...
    namespace balanceOfEnergy {
        ...
        void computeBalanceOfEnergy(
            ...
            TARDIGRADE_ERROR_TOOLS_CHECK(
                (nphases * configuration::material::num_phase_dof + configuration::material::num_additional_dof) * configuration::material::dimension ==
            ...
            for (auto v = std::pair<unsigned int, density_iter>(0, density_begin); v.second != density_end;
                ...
                computeBalanceOfEnergy<
                    ...
                    dRdUMesh_iter, configuration::material::density_index, configuration::material::displacement_index, configuration::material::velocity_index, configuration::material::temperature_index,
