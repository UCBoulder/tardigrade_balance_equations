...
BOOST_AUTO_TEST_CASE( test_QuadraticHex, * boost::unit_test::tolerance( DEFAULT_TEST_TOLERANCE ) ){
    ...
    std::array< floatType, 60 > xi = { -1.000000000e+00, -1.000000000e+00, -1.000000000e+00,
    ...
    std::array< floatType, 60 > X = { +0.000000000e+00, +0.000000000e+00, +0.000000000e+00,
                                      ...
                                      +1.000000000e+00, +5.000000000e-01, +0.000000000e+00,
                                      +5.000000000e-01, +1.000000000e+00, +0.000000000e+00,
                                      +0.000000000e+00, +5.000000000e-01, +0.000000000e+00,
                                      +5.000000000e-01, +0.000000000e+00, +1.000000000e+00,
                                      +1.000000000e+00, +5.000000000e-01, +1.000000000e+00,
                                      +5.000000000e-01, +1.000000000e+00, +1.000000000e+00,
                                      +0.000000000e+00, +5.000000000e-01, +1.000000000e+00,
                                      +0.000000000e+00, +0.000000000e+00, +5.000000000e-01,
                                      +1.000000000e+00, +0.000000000e+00, +5.000000000e-01,
                                      +1.000000000e+00, +1.000000000e+00, +5.000000000e-01,
                                      +0.000000000e+00, +1.000000000e+00, +5.000000000e-01 };
    ...
    tardigradeBalanceEquations::finiteElementUtilities::QuadraticHex<floatType, typename std::array< floatType, 60 >::const_iterator, typename std::array< floatType, 3>::const_iterator, typename std::array< floatType, 20>::iterator, typename std::array< floatType, 60>::iterator> e( std::cbegin( x ), std::cend( x ), std::cbegin( X ), std::cend( X ) );
    ...
    answer = { -0.25, -0.25, -0.25, -0.25, -0.25, -0.25, -0.25, -0.25,
...
BOOST_AUTO_TEST_CASE( test_QuadraticHex2, * boost::unit_test::tolerance( DEFAULT_TEST_TOLERANCE ) ){
    ...
    std::array< floatType, 20*4 > quantities = {
        -2.581465141e-01, +3.297684532e-01, -6.683990931e-03, +2.041580954e-01,
        -5.116301113e-01, -1.050387725e-02, +4.210808295e-01, -9.721523782e-02,
        -9.059246807e-01, +6.195543359e-02, +1.061158088e-01, -7.711300713e-01,
        -5.090515143e-01, +6.734037985e-01, +8.115901223e-01, -4.968685792e-01,
        -5.946891962e-01, +2.666253030e-01, -9.519217106e-01, +4.322266506e-01,
        +7.960701698e-01, -6.494674834e-01, +4.290239639e-02, -5.600843628e-01,
        +7.191786725e-01, +1.747178591e-01, -2.948180939e-01, -6.041881881e-02,
        -4.472549030e-01, -7.042590916e-01, -3.255481872e-01, -5.727464800e-01,
        +6.439562259e-01, -6.610541328e-01, +8.786398339e-01, +7.562994040e-01,
        -6.350302971e-01, -5.609524198e-01, +3.188754883e-01, +9.038765763e-01,
        -9.806126697e-01, +5.825500203e-01, +7.640208052e-01, -6.252148470e-01,
        +6.846030636e-01, -2.126818044e-02, -3.881186564e-01, -7.119225455e-01,
        -7.366425047e-01, +5.293732966e-01, -1.080907759e-01, -3.442208103e-01,
        +6.564608055e-01, -7.686106625e-01, -9.191327509e-01, +8.221293722e-01,
        -1.650269651e-01, -4.654258360e-01, +3.929470640e-01, +7.849815680e-01,
        -8.129219521e-01, -2.200162818e-01, +1.317284240e-01, +3.523961174e-01,
        -8.367614598e-01, -9.211575885e-01, +2.818603460e-01, +5.221061869e-01,
        +9.918942317e-01, +2.797250987e-01, -4.055630010e-01, -1.573836867e-01,
        +2.238366118e-01, +2.762281524e-01, +3.711713723e-01, +1.956957552e-01,
        -1.196331340e-01, +7.296372214e-01, -2.629868301e-01, +5.585957159e-01
    };
...
BOOST_AUTO_TEST_CASE( test_QuadraticHex3, * boost::unit_test::tolerance( DEFAULT_TEST_TOLERANCE ) ){
    ...
    std::array< floatType, 20 * 3 > answer = {
        +8.458348050e-01, +3.632219699e-01, -4.688684357e-01,
        +1.463823677e+00, +1.198490629e-01, -1.130343261e+00,
        +4.681267498e-01, -4.856208634e-01, -1.129042247e-01,
        +1.051851273e+00, -1.211559191e-01, -3.620896831e-01,
        +7.440023149e-01, +5.116796729e-01, -8.929739763e-01,
        +2.067033117e-01, +2.821793576e-01, -8.086240235e-01,
        +4.169490940e-01, -1.784155895e-01, -5.857161174e-01,
        +6.681412321e-01, +6.802268622e-02, -5.665370610e-01,
        -6.020028291e-01, -1.044935908e+00, -1.542915989e-01,
        +5.512509503e-01, +1.634329385e+00, -1.171880270e+00,
        -1.170860567e+00, +4.611636116e-01, +1.559517186e-01,
        -1.436379797e+00, -2.308104438e-03, +3.603737428e-01,
        -6.137805961e-01, -6.515482615e-01, +1.030780936e+00,
        -2.503542839e-01, +1.543464278e-01, +6.705528762e-01,
        -5.187677104e-01, -2.956775695e-03, +4.770759820e-01,
        -6.010498433e-01, -1.423978525e-01, +5.478263648e-01,
        -9.747325517e-01, -8.083679309e-01, +1.082907821e+00,
        +8.134092215e-01, -5.549512902e-01, +9.001620459e-01,
        -3.686867186e-01, +4.352539484e-01, +5.235912803e-01,
        -6.934777324e-01, -3.738762767e-02, +5.050058842e-01
    };
    ...
    answer = {
        +4.480811161e-01, -2.065459081e-03, -2.759991526e-02,
        +4.194015946e-01, -4.279136183e-01, -4.540533539e-01,
        -2.113780134e-02, -4.933538806e-01, -1.152103924e-02,
        +3.688540127e-01, -3.994355406e-01, +6.323402287e-02,
        +3.084076662e-01, +7.462607781e-02, -4.458838801e-01,
        -5.387738899e-02, +4.706926217e-02, -6.323828749e-01,
        -7.712361202e-02, -3.173806690e-01, -4.239590974e-01,
        +1.791478975e-01, -1.924314928e-01, -2.530222336e-01,
        -8.674827107e-01, -6.537739752e-01, -6.036401761e-01,
        +6.317044710e-01, +9.212674989e-01, -5.690532570e-01,
        -3.477162114e-01, +6.537739752e-01, -2.419592604e-01,
        -6.317044710e-01, +4.015009996e-01, -2.480012068e-01,
        -2.545302772e-01, -1.918254613e-01, +6.036401761e-01,
        +1.853499927e-01, +2.703114068e-01, +5.690532570e-01,
        -1.020242854e-01, +1.918254613e-01, +2.419592604e-01,
        -1.853499927e-01, +1.178054150e-01, +2.480012068e-01,
        -5.008157215e-01, -2.129449222e-01, +4.734837953e-01,
        +5.008157215e-01, -4.886145641e-01, +1.086436229e+00,
        +2.007437648e-01, +4.886145641e-01, +4.354801367e-01,
        -2.007437648e-01, +2.129449222e-01, +1.897882107e-01
    };
