...
BOOST_AUTO_TEST_CASE(test_compute_current_rate_of_change, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    ...
    tardigradeBalanceEquations::finiteElement::compute_current_rate_of_change(dt, std::begin(v_t), std::end(v_t), std::begin(v_tp1), std::end(v_tp1), std::begin(vDot_t), std::end(vDot_t),alpha, std::begin(vDot_tp1), std::end(vDot_tp1), dVDotdV);
...

    {
        ...
        for ( unsigned int i = 0; i < NUM_VAR; ++i){
            ...
            tardigradeBalanceEquations::finiteElement::compute_current_rate_of_change(dt, std::begin(v_t), std::end(v_t), std::begin(xp), std::end(xp), std::begin(vDot_t), std::end(vDot_t),alpha, std::begin(rp), std::end(rp), tempp);

            tardigradeBalanceEquations::finiteElement::compute_current_rate_of_change(dt, std::begin(v_t), std::end(v_t), std::begin(xm), std::end(xm), std::begin(vDot_t), std::end(vDot_t),alpha, std::begin(rm), std::end(rm), tempm);
...
BOOST_AUTO_TEST_CASE(test_compute_current_acceleration, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    ...
    tardigradeBalanceEquations::finiteElement::compute_current_acceleration(dt, std::begin(v_t), std::end(v_t), std::begin(v_tp1), std::end(v_tp1), std::begin(vDot_t), std::end(vDot_t), std::begin(vDDot_t), std::end(vDDot_t), alpha, beta, std::begin(vDDot_tp1), std::end(vDDot_tp1), dVDDotdV);
...

    {
        ...
        for ( unsigned int i = 0; i < NUM_VAR; ++i){
            ...
            tardigradeBalanceEquations::finiteElement::compute_current_acceleration(dt, std::begin(v_t), std::end(v_t), std::begin(xp), std::end(xp), std::begin(vDot_t), std::end(vDot_t), std::begin(vDDot_t), std::end(vDDot_t), alpha, beta, std::begin(rp), std::end(rp), tempp);

            tardigradeBalanceEquations::finiteElement::compute_current_acceleration(dt, std::begin(v_t), std::end(v_t), std::begin(xm), std::end(xm), std::begin(vDot_t), std::end(vDot_t), std::begin(vDDot_t), std::end(vDDot_t), alpha, beta, std::begin(rm), std::end(rm), tempm);
