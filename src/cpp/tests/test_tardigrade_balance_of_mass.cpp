         0.00857208,  0.07178337,  0.03043077, -0.05340402,  0.05491604,
        -0.0730773 , -0.06688801,  0.02253646, -0.05224332,  0.04095571,
        -0.03009629, -0.04451521,  0.09978368, -0.09187678,  0.0291645 ,
        -0.09226008,  0.05204205, -0.05398201, -0.08203363,  0.02968994,
         0.04652024,  0.03561906, -0.08961981, -0.04113861, -0.00978233,
        -0.04257934,  0.06210269, -0.07377698,  0.02243587,  0.09764299,
         0.08051131, -0.05556859, -0.09998362,  0.09611947,  0.0765426 ,
         0.08389449, -0.01689929,  0.04892309, -0.0574337 , -0.02153919,
         0.07030961, -0.07447756,  0.07877307, -0.00069841, -0.01478087,
        -0.03887072
    };
    ...
    std::array< floatType, 8 * nphases > vf_tp1 = {
        0.97988631, 0.66843312, 0.23976947, 0.01519766, 0.21868214,
        0.45551964, 0.39342034, 0.81232624, 0.78555676, 0.08909597,
        0.95201072, 0.52745668, 0.59640396, 0.40505677, 0.64950096,
        0.8713263 , 0.67393597, 0.97009854, 0.70112225, 0.82172074,
        0.04503958, 0.67269851, 0.65475264, 0.10174605, 0.8423875 ,
        0.6141724 , 0.09832809, 0.59446712, 0.47841585, 0.23329357,
...
class hydraLinearTest2 : public tardigradeHydra::hydraBase{
    ...
    private:
        ...
        virtual void setResidualClasses( ) override{
            ...
            TARDIGRADE_ERROR_TOOLS_CATCH( residual = tardigradeHydra::linearTestMaterial::residual( this, 22, linear_test_params2 ) );
        ...
        for ( unsigned int k = 0; k < node_count; ++k ){
            ...
            if ( active_phase >= 0 ){
                ...
                tardigradeBalanceEquations::balanceOfMass::computeDiffusionTerm<dim,10,num_dof>(
                    std::cbegin( material_response ),          std::cend( material_response ),
                    std::cbegin( material_response_jacobian ), std::cend( material_response_jacobian ),
                    std::cbegin( dNdxs ) + dim * i,            std::cbegin( dNdxs ) + dim * ( i + 1 ),
                    Ns[ k ],
                    std::cbegin( dNdxs ) + dim * k,               std::cbegin( dNdxs ) + dim * ( k + 1 ),
                    std::begin( dof_vector ) + ( nphases * num_phase_dof + num_additional_dof ), std::end( dof_vector ),
                    dUDotdU,
...
BOOST_AUTO_TEST_CASE( test_computeBalanceOfMass_hydra_diffusionTerm_fea, * boost::unit_test::tolerance( 1e-5 ) ){
    ...
    std::array< floatType, 8 * nphases > answer = {
        0.21938246,  0.23216262,  0.20213508,  0.23139603,  0.12642431,
        0.13425267,  0.11564689,  0.13373552,  0.08075729,  0.08490545,
        0.0730933 ,  0.08410922,  0.1484464 ,  0.15578825,  0.13591399,
        0.15464239,  0.32094025,  0.34621113,  0.30988   ,  0.35080769,
       -0.20366515, -0.20440775, -0.18900152, -0.20061771, -0.49920827,
       -0.53203568, -0.46963165, -0.53396482, -0.19307729, -0.21687669,
       -0.17803609, -0.22010831
    };
