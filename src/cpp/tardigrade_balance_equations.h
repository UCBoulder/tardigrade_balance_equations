...
namespace tardigradeBalanceEquations {
     ...
     */
    template<int _num_phase_dof, int _num_additional_dof, int _dimension = 3, class _output = MaterialResponseOutputConfigurationBase<>, class _dof = MaterialResponseDOFConfigurationBase<_num_phase_dof, _num_additional_dof>>
