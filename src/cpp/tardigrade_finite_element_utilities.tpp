...
namespace tardigradeBalanceEquations {
    ...
    namespace finiteElement {
         ...
         * \param &beta: The integration parameter for the acceleration (second time derivative) (0 is explicit, 1 is implicit)
         * \param &vDDot_tp1_begin: The starting iterator of the current dof acceleration (second time derivative) vector
