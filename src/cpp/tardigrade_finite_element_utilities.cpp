...
namespace tardigradeBalanceEquations{
    ...
    namespace finiteElementUtilities{
        ...
        ) : FiniteElementBase<3,3,20,node_in,typename std::array< T, 3 * 20 >::const_iterator,local_point_in,shape_functions_out,grad_shape_functions_out>(
            _x_begin, _x_end, _X_begin, _X_end, std::cbegin( local_nodes ), std::cend( local_nodes )
        ){
            /*!
        ...
        void QuadraticHex<T,node_in,local_point_in,shape_functions_out,grad_shape_functions_out>::GetShapeFunctions(
            const local_point_in &xi_begin, const local_point_in &xi_end, shape_functions_out N_begin, shape_functions_out N_end
        ){
            /*!
            ...
            TARDIGRADE_ERROR_TOOLS_CHECK( ( size_type )( N_end - N_begin ) == 20, "The dimension of the shape-function iterator is " + std::to_string( ( size_type )( N_end - N_begin ) ) + " but should be 20" );
        ...
        template<typename T, class node_in, class local_point_in, class shape_functions_out, class grad_shape_functions_out>
        void QuadraticHex<T,node_in,local_point_in,shape_functions_out,grad_shape_functions_out>::GetLocalShapeFunctionGradients( const local_point_in &xi_begin, const local_point_in &xi_end, grad_shape_functions_out dNdxi_begin, grad_shape_functions_out dNdxi_end ){
            /*!
            ...
            TARDIGRADE_ERROR_TOOLS_CHECK( ( size_type )( dNdxi_end - dNdxi_begin ) == 60, "The dimension of the shape-function iterator is " + std::to_string( ( size_type )( dNdxi_end - dNdxi_begin ) ) + " but should be 60" );

            // Set the first 8 nodes
            for ( unsigned int i = 0; i < 8; ++i ){

                *( dNdxi_begin + 3 * i + 0 ) = -0.125 * (
            ...
            for ( unsigned int i = 0; i < 4; ++i ){
                ...
                *( dNdxi_begin +  3 * ( 8 + 2 * i + 0 ) + 0 ) = 0.500 * ( -( *( xi_begin + 0 ) ) )
                                                                      * ( 1 + ( *( this->local_node_xi_begin + 3 * ( 2 * i + 0 ) + 1 ) ) * ( *( xi_begin + 1 ) ) )
                                                                      * ( 1 + ( *( this->local_node_xi_begin + 3 * ( 2 * i + 0 ) + 2 ) ) * ( *( xi_begin + 2 ) ) );

                *( dNdxi_begin +  3 * ( 8 + 2 * i + 0 ) + 1 ) = 0.250 * ( ( 1 - ( *( xi_begin + 0 ) ) ) * ( 1 + ( *( xi_begin + 0 ) ) ) )
                                                                      * ( *( this->local_node_xi_begin + 3 * ( 2 * i + 0 ) + 1 ) )
                                                                      * ( 1 + ( *( this->local_node_xi_begin + 3 * ( 2 * i + 0 ) + 2 ) ) * ( *( xi_begin + 2 ) ) );

                *( dNdxi_begin +  3 * ( 8 + 2 * i + 0 ) + 2 ) = 0.250 * ( ( 1 - ( *( xi_begin + 0 ) ) ) * ( 1 + ( *( xi_begin + 0 ) ) ) )
                                                                      * ( 1 + ( *( this->local_node_xi_begin + 3 * ( 2 * i + 0 ) + 1 ) ) * ( *( xi_begin + 1 ) ) )
                                                                      * ( *( this->local_node_xi_begin + 3 * ( 2 * i + 0 ) + 2 ) );

                *( dNdxi_begin +  3 * ( 8 + 2 * i + 1 ) + 0 ) = 0.250 * ( ( 1 - ( *( xi_begin + 1 ) ) ) * ( 1 + ( *( xi_begin + 1 ) ) ) )
                                                                      * ( *( this->local_node_xi_begin + 3 * ( 2 * i + 1 ) + 0 ) )
                                                                      * ( 1 + ( *( this->local_node_xi_begin + 3 * ( 2 * i + 1 ) + 2 ) ) * ( *( xi_begin + 2 ) ) );

                *( dNdxi_begin +  3 * ( 8 + 2 * i + 1 ) + 1 ) = 0.500 * ( -( *( xi_begin + 1 ) ) )
                                                                      * ( 1 + ( *( this->local_node_xi_begin + 3 * ( 2 * i + 1 ) + 0 ) ) * ( *( xi_begin + 0 ) ) )
                                                                      * ( 1 + ( *( this->local_node_xi_begin + 3 * ( 2 * i + 1 ) + 2 ) ) * ( *( xi_begin + 2 ) ) );

                *( dNdxi_begin +  3 * ( 8 + 2 * i + 1 ) + 2 ) = 0.250 * ( ( 1 - ( *( xi_begin + 1 ) ) ) * ( 1 + ( *( xi_begin + 1 ) ) ) )
                                                                      * ( 1 + ( *( this->local_node_xi_begin + 3 * ( 2 * i + 1 ) + 0 ) ) * ( *( xi_begin + 0 ) ) )
                                                                      * ( *( this->local_node_xi_begin + 3 * ( 2 * i + 1 ) + 2 ) );

                *( dNdxi_begin + 3 * ( 16 + 1 * i + 0 ) + 0 ) = 0.250 * ( ( 1 - ( *( xi_begin + 2 ) ) ) * ( 1 + ( *( xi_begin + 2 ) ) ) )
                                                                      * ( *( this->local_node_xi_begin + 3 * ( 16 + 1 * i + 0 ) + 0 ) )
                                                                      * ( 1 + ( *( this->local_node_xi_begin + 3 * ( 16 + 1 * i + 0 ) + 1 ) ) * ( *( xi_begin + 1 ) ) );

                *( dNdxi_begin + 3 * ( 16 + 1 * i + 0 ) + 1 ) = 0.250 * ( ( 1 - ( *( xi_begin + 2 ) ) ) * ( 1 + ( *( xi_begin + 2 ) ) ) )
                                                                      * ( 1 + ( *( this->local_node_xi_begin + 3 * ( 16 + 1 * i + 0 ) + 0 ) ) * ( *( xi_begin + 0 ) ) )
                                                                      * ( *( this->local_node_xi_begin + 3 * ( 16 + 1 * i + 0 ) + 1 ) );

                *( dNdxi_begin + 3 * ( 16 + 1 * i + 0 ) + 2 ) = 0.500 * ( -( *( xi_begin + 2 ) ) )
                                                                      * ( 1 + ( *( this->local_node_xi_begin + 3 * ( 16 + 1 * i + 0 ) + 0 ) ) * ( *( xi_begin + 0 ) ) )
                                                                      * ( 1 + ( *( this->local_node_xi_begin + 3 * ( 16 + 1 * i + 0 ) + 1 ) ) * ( *( xi_begin + 1 ) ) );
        ...
        template<typename T, class node_in, class local_point_in, class shape_functions_out, class grad_shape_functions_out>
        void QuadraticHex<T,node_in,local_point_in,shape_functions_out,grad_shape_functions_out>::GetGlobalShapeFunctionGradients(
            const local_point_in &xi_begin, const local_point_in &xi_end,
            const node_in &node_positions_begin, const node_in &node_positions_end,
            grad_shape_functions_out value_begin, grad_shape_functions_out value_end ){
            /*!
            ...
            TARDIGRADE_ERROR_TOOLS_CHECK( ( size_type )( value_end - value_begin ) == 60, "The shape function global gradient has a size of " + std::to_string( ( unsigned int )( value_end - value_begin ) ) + " but must have a size of 60" );
        ...
        template<typename T, class node_in, class local_point_in, class shape_functions_out, class grad_shape_functions_out>
        void QuadraticHex<T,node_in,local_point_in,shape_functions_out,grad_shape_functions_out>::GetVolumeIntegralJacobianOfTransformation(
            const local_point_in &xi_begin, const local_point_in &xi_end,
            typename std::iterator_traits<node_in>::value_type &value, const bool configuration ){
            /*!
             * Compute the value of the Jacobian of transformation from the local coordinates to the configuration for volume integrals
