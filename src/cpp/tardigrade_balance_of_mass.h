...
namespace tardigradeBalanceEquations {
    ...
    namespace balanceOfMass {
        ...
        constexpr unsigned int global_sot_dim =
            global_dim * global_dim;  //!< Set the dimensions of a standard second order tensor
        ...
        inline void computeBalanceOfMass(const floatType &density, const floatType &density_dot,
        ...
        inline void computeBalanceOfMass(
            ...
            const dDensityDotdDensity_type &dDensityDotdDensity, const dUDotdU_type &dUDotdU, result_type &result,
