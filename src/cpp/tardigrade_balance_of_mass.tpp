    ...
    namespace balanceOfMass {
        ...
        void computeBalanceOfMass(
            ...
            for (auto p = std::pair<unsigned int, dRdRho_iter>(0, dRdRho_begin); p.second != dRdRho_end;
                ...
                *p.second -= test_function *
                             (*(material_response_jacobian_begin +
                                (nphases * num_phase_dof + configuration::material::num_additional_dof) * (1 + configuration::material::dimension) *
                                    mass_change_index +
                ...
                for (unsigned int a = 0; a < configuration::material::dimension; ++a) {
                    *p.second -= test_function *
                                 (*(material_response_jacobian_begin +
                                    (nphases * num_phase_dof + configuration::material::num_additional_dof) * (1 + configuration::material::dimension) *
                                        mass_change_index +
                                    (nphases * num_phase_dof + configuration::material::num_additional_dof) +
            ...
            *(dRdRho_begin + phase) += phase_dRdRho;
            ...
            for (unsigned int i = 0; i < (nphases * num_phase_dof + configuration::material::num_additional_dof); ++i) {
                    ...
                    for (unsigned int a = 0; a < configuration::material::dimension; ++a) {
                        *(dRdUMesh_begin + a) +=
                            ...
                            (*(material_response_jacobian_begin +
                               (nphases * num_phase_dof + configuration::material::num_additional_dof) * (1 + configuration::material::dimension) *
                                   mass_change_index +
                               (nphases * num_phase_dof + configuration::material::num_additional_dof) + configuration::material::dimension * i + j)) *
        ...
        void computeBalanceOfMass(
             ...
             * + configuration::material::num_additional_dof ) degrees of freedom followed by the gradients of these degrees of freedom for the
             ...
             * mass_change_index is the index of the material response vector that represents the mass change rate
             * configuration::material::dimension is the spatial dimension of the material-response Jacobian
             * ( nphases * num_phase_dof + configuration::material::num_additional_dof ) are the number of degrees of freedom in the
            ...
            TARDIGRADE_ERROR_TOOLS_CHECK(
                nphases * material_response_size * (nphases * num_phase_dof + configuration::material::num_additional_dof) *
                ...
                "configuration::material::num_dof\n  number of phases           : " +
                    ...
                    std::to_string(nphases * material_response_size * (nphases * num_phase_dof + configuration::material::num_additional_dof) *
                                   (1 + configuration::material::dimension)) +
            ...
            TARDIGRADE_ERROR_TOOLS_CHECK(nphases * configuration::material::num_additional_dof == (unsigned int)(dRdZ_end - dRdZ_begin),
            ...
            for (auto v = std::pair<unsigned int, density_iter>(0, density_begin); v.second != density_end;
                ...
                computeBalanceOfMass<
                    ...
                    *(result_begin + v.first), dRdRho_begin + nphases * 1 * v.first,
                    ...
                    dRdZ_begin + configuration::material::num_additional_dof * v.first, dRdZ_begin + configuration::material::num_additional_dof * (v.first + 1),
        ...
        void computeDiffusionTerm(
            ...
            TARDIGRADE_ERROR_TOOLS_CHECK((unsigned int)(dRdZ_end - dRdZ_begin) == configuration::material::num_additional_dof,
                                         "dRdZ is an inconsistent size (" + std::to_string(dRdZ_end - dRdZ_begin) +
                                             ") with the number of additional degrees of freedom (" +
                                             std::to_string(configuration::material::num_additional_dof) + ")")
            ...
            for (auto v = std::pair<unsigned int, result_iter>(0, result_begin); v.second != result_end;
                ...
                computeDiffusionTerm<
                    ...
                    material_response_jacobian_begin + material_response_size *
                                                           ...
                                                           (1 + configuration::material::dimension) * v.first,
                    material_response_jacobian_begin +
                        material_response_size * (nphases * num_phase_dof + configuration::material::num_additional_dof) *
                            (1 + configuration::material::dimension) * (v.first + 1),
